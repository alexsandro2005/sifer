...
<body>
    ...
    <div class="container_all">
        <div class="ctn-form">
            <header>
                ...
                <h1 class="title"> <span>INICIO DE SESION</span></h1>
            </header>
            ...
            <form action="controller/inicio.php" method="POST" autocomplete="off" id="formulario" class="formulario">
                ...
                <div class="formulario__grupo" id="grupo__document">
                    ...
                    <div class="formulario__grupo-input">
                        <input type="text" autofocus onkeypress="return(multiplenumber(event));" minlength="6" maxlength="10" oninput="maxlengthNumber(this);" class="formulario__input" name="document" id="document" required placeholder="Ingrese su numero de documento">
                        <i class="formulario__validacion-estado fas fa-times-circle"></i>
                    </div>
                    <p class="formulario__input-error">El numero de documento debe ser en un rango de 6 a 10 numeros.</p>
                </div>
                ...
                <div class="formulario__grupo" id="grupo__username">
                    ...
                    <div class="formulario__grupo-input">
                        <input type="text" minlength="6" maxlength="12" oninput="maxlengthNumber(this);" class="formulario__input" name="username" required id="username" onkeypress="return(multipletext(event));" placeholder="Ingrese su nombre de usuario">
                        <i class="formulario__validacion-estado fas fa-times-circle"></i>
                    </div>
                ...
                <div class="formulario__grupo" id="grupo__password">
                    ...
                    <div class="formulario__grupo-input">
                        <input type="password" onkeypress="return(multipletext(event));" class="formulario__input" oninput="maxlengthNumber(this);" maxlength="12" name="password" minlength="10" required id="password" placeholder="Ingrese su contraseña">
                        <i class="formulario__validacion-estado fas fa-times-circle"></i>
                    </div>
    ...
    <script>
        function multipletext(e) {
            ...
            letras = "qwertyuiopasdfghjklñzxcvbnm0123456789_";
    ...
    <!-- TYPED JS -->
    <script src="controller/JS/typed.js"></script>
