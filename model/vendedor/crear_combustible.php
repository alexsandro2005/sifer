...
<?php
...

    {
        ...
        if ($register_validation){
            ...
            echo '<script> window.location= "crear_combustible.php"</script>';
        ...
        {
            $register_user=$connection->prepare("INSERT INTO combustible(combustible) VALUES('$combustible')");
            $register_user->execute();
            echo '<script>alert("// Estimado Usuario el registro del tipo de combustible ha sido exitoso.//");</script>';
...
<head>
    ...
    <title>CREAR COMBUSTIBLE || SIFER-APP</title>
...
<body onload="formreg.id_modelos.focus()">
    ...
    <main>
        ...
        <div class="container_title">
            <header>CREAR COMBUSTIBLE</header>
        </div>
        <form method="POST" name="formreg" action="" autocomplete="off" id="formulario" class="formulario">
			...
			<div class="formulario__grupo" id="grupo__marca">
				...
				<div class="formulario__grupo-input">
					<input type="text" class="formulario__input" name="combustible" required id="marca" maxlength="20" oninput="maxlengthNumber(this);" onkeypress="return(multipletext(event));" placeholder="Ingrese nuevo tipo de combustible para moto.">
