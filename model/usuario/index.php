                            ...
                            ?>
                                <tr>
                                    ...
                                    <div class=" d-flex flex-column">
                                        <th>
                                            <form method="get" action="historialAceite.php">

                                                <input type="hidden" name="placa" value="<?= $motos['placa'] ?>">
                                                <button class="button button_actu" onclick="return confirm('¿Deseas ver los servicios adquiridos?');" type="submit">Compras Servicios</button>
                                            </form>

                                        </th>

                                        <th>
                                            <form method="get" action="historial_documentos.php">

                                                <input type="hidden" name="placa" value="<?= $motos['placa'] ?>">
                                                <button class="button button_actu" onclick="return confirm('¿Deseas ver los seguros?');" type="submit">Compras Seguros</button>
                                            </form>
                                        ...
                                        <th>
                                            <form method="get" action="ventas.php">
                                                ...
                                                <input type="hidden" name="placa" value="<?= $motos['placa'] ?>">
                                                <button class="button button_actu" onclick="return confirm('¿Desea actualizar el registro de la moto seleccionado?');" type="submit">Compras Productos</button>
                                            </form>
