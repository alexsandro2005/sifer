...
$servicios = $_GET['placa'];

$sentencia = $connection->query("SELECT * FROM trigger_documents INNER JOIN documentos WHERE placa = '$servicios' AND trigger_documents.codigo_documento = documentos.codigo ");
...
<head>
    ...
    <title>ACTUALIZACION SEGUROS || SIFER-APP</title>
    <!-- Bootstrap CSS -->
...
<body>
    <div class="wrapper">
        ...
        <div class="xp-breadcrumbbar text-center">
            <h2 class="page-title"><span>ACTUALIZACION SEGUROS </span></h2>
                    ...
                    try {
                        ...
                        if (!empty($ventas)) {
                            foreach ($ventas as $venta) {
                                ...
                                $fechaVenta = new DateTime($venta['fecha_registro']);
