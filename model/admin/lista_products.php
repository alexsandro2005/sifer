        ...
        <div id="content">
            ...
            <div class="mt-3">
                ...
                try {
                    ...
                    $productos->execute();
                    $comprar_productos = $productos->fetch(PDO::FETCH_ASSOC);


                    if (count($comprar_productos) > 0) {
                        echo '<div class="alert mt-lg-3 alert-danger" role="alert">';
                        echo  '<ul>';

                        foreach ($productos as $desgastados) {
                                        ...
                                        <tr>
                                            ...
                                            <th>
                                                ...
                                                <form method="get" action="eliminar.php">
                                                    <input type="hidden" name="id" value="<?= $rows['id'] ?>">
                                                    <button class="button" onclick="return confirm('¿Desea eliminar el registro de producto seleccionado?');" type="submit"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></button>
                                                </form>
                                                </a>
                                            </th>
