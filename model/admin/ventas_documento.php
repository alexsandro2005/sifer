                                ...
                                <tbody>
                                    <?php foreach ($ventas as $venta) { ?>
                                        <tr>
                                            ...
                                            <td><a class="btn btn-info" href="<?php echo "imprimirTicket.php?id_venta=" . $venta->id_venta ?>" style="color:white;">Facturar <i class="fa fa-print"></i></a></td>
