...
<body>
	...
	<div class="container-fluid">
		...
		<div class="horizontal-menu">
			...
			<!-- Segundo enlace -->
			<a onclick="toggleContent('content2')">Documentos</a>
					...
					<tbody>
						...
						?>
							<tr>
								...
								<td><a class="btn btn-daservicioger" href="<?php echo "deleteService.php?indice=" . $indice ?>" Style='color:white;'>Eliminar<i class="fa fa-trash"></i></a></td>
							</tr>
						<?php } ?>
					</tbody>
				</table>
