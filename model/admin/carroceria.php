...
<?php
...

    {
        ...
        if ($register_validation){
            ...
            echo '<script> window.location= "carroceria.php"</script>';
        ...
        {
            $register_carro=$connection->prepare("INSERT INTO carroceria(carroceria) VALUES ('$carroceria')" );
            if($register_carro->execute()){
                echo '<script>alert("// Estimado Usuario el registro de la nueva carroceria ¡ha sido exitoso!.//");</script>';
...
<head>
    ...
    <title>CREAR CARROCERIA || SIFER-APP</title>
...
<body onload="formreg.id_modelos.focus()">
    ...
    <main>
        <div class="container_title">
            <header>CREAR CARROCERIA</header>
        </div>
        <form method="POST" name="formreg" action="" autocomplete="off" id="formulario" class="formulario">
			...
			<div class="formulario__grupo" id="grupo__categoria">
				...
				<div class="formulario__grupo-input">
					<input type="text" class="formulario__input" maxlength="15" onkeypress="return(multipletext(event));" oninput="maxlengthNumber(this);" name="carroceria" id="categoria" required placeholder="Ingrese el nuevo tipo de carroceria">
