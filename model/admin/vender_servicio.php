		...
		<div class="wrapper">
			...
			<div id="content">
				...
				<table class="table table-bordered">
					...
					<tbody>
						<?php foreach ($_SESSION["carrito_servicio"] as $indice => $servicio) {
							$granTotal += $servicio->total;
						?>
							<tr>
								<td><?php echo $servicio->id ?></td>
								<td><?php echo $servicio->codigo ?></td>
								<td><?php echo $servicio->name_pro ?></td>
								<td><?php echo $servicio->precio ?></td>
								<td><?php echo $servicio->id_marca ?></td>
								<td><?php echo $servicio->total ?></td>
								<td><?php echo $servicio->cantidad ?></td>
								<td><a class="btn btn-danger" href="<?php echo "quitarServicio.php?indice=" . $indice ?>" Style='color:white;'>Eliminar<i class="fa fa-trash"></i></a></td>
							</tr>
						<?php } ?>
					</tbody>
				</table>
