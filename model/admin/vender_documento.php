		...
		<div id="content">
			...
			<div class="col-xs-14">
				...
				?>
					...
					?>
						<div class="alert alert-info">
							<strong>Retiroso exitoso</strong>, Documento retirado de la lista.
						</div>
					<?php
					} else if ($_GET["status"] === "4") {
					?>
						<div class="alert alert-warning">
							<strong>Error:</strong> El documento que buscas no esta registrado.
						</div>
					<?php
					}
					else {
			...
			<!------top-navbar-end----------->
			<br>
			<form method="post" action="carrito_documento.php">
			...
			<form action="./terminar_VentaDocu.php" method="POST">
				<br>
